...
vim.api.nvim_set_hl(0, 'Number',			{ ctermfg = "Magenta", fg = red } )
vim.api.nvim_set_hl(0, 'String',			{ ctermfg = "Magenta", fg = magenta } )
vim.api.nvim_set_hl(0, 'Character',			{ ctermfg = "Magenta", fg = lightmagenta } )
vim.api.nvim_set_hl(0, 'Boolean',			{ ctermfg = "Magenta", fg = red } )
...
vim.api.nvim_set_hl(0, 'Constant',			{ ctermfg = "Magenta", fg = magenta } )
vim.api.nvim_set_hl(0, 'Constant',			{ ctermfg = "Magenta", fg = magenta } )
vim.api.nvim_set_hl(0, 'Constant',			{ ctermfg = "Magenta", fg = magenta } )
vim.api.nvim_set_hl(0, 'Constant',			{ ctermfg = "Magenta", fg = magenta } )
